...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await apiClient.post<ApiSuccess<AuthResponseData>>('/auth/login', {
        email,
        password,
      });
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-950 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1.5 text-sm text-gray-400">Sign in to your IncidentHub AI workspace</p>
        </div>
